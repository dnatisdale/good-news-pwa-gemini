    ...
    <div className="p-4 pt-8 h-full flex flex-col">
      ...
      <div className="flex flex-col items-center mb-6">
        ...
        <button
          ...
          className="mt-2 text-sm font-semibold text-gray-500 hover:text-red-600 dark:text-gray-400 dark:hover:text-red-400 transition-colors"
        >
      ...
      <div className="flex justify-center mb-4">
        <div className="grid grid-cols-2 gap-3 max-w-[280px] w-full">
          <button
            onClick={onShare}
            className="aspect-square bg-[#A51C30] text-white p-2.5 rounded-lg flex flex-col items-center justify-center shadow hover:bg-[#8B1826] transition-all duration-200 hover:scale-105 active:scale-95 hover:shadow-lg"
          >
            <Share2 className="w-6 h-6 mb-1" />
            <span className="text-xs font-medium leading-tight">{t.share || "Share"}</span>
          </button>
          <button
            onClick={onCopy}
            className="aspect-square bg-[#A51C30] text-white p-2.5 rounded-lg flex flex-col items-center justify-center shadow hover:bg-[#8B1826] transition-all duration-200 hover:scale-105 active:scale-95 hover:shadow-lg"
          >
            ...
            <span className="text-xs font-medium leading-tight">{t.copy || "Copy"}</span>
          </button>
      ...
      {count === 0 && (
        <div className="text-center px-4 mb-6">
          ...
          <button
            onClick={onBack}
            className="bg-[#A51C30] text-white px-6 py-2.5 rounded-lg font-medium shadow hover:bg-[#8B1826] transition-all duration-200 hover:scale-105 active:scale-95"
          >
            {t.go_back || "Go Back"}
          </button>
        </div>
